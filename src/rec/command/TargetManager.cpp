...
"  <MAPPING commandId=\"14\" description=\"Select loop 1.\" key=\"!\"/>"
"  <MAPPING commandId=\"15\" description=\"Select loop 2.\" key=\"@\"/>"
"  <MAPPING commandId=\"16\" description=\"Select loop 3.\" key=\"#\"/>"
"  <MAPPING commandId=\"17\" description=\"Select loop 4.\" key=\"$\"/>"
"  <MAPPING commandId=\"18\" description=\"Select loop 5.\" key=\"%\"/>"
"  <MAPPING commandId=\"19\" description=\"Select loop 6.\" key=\"^\"/>"
"  <MAPPING commandId=\"1a\" description=\"Select loop 7.\" key=\"&\"/>"
"  <MAPPING commandId=\"1b\" description=\"Select loop 8.\" key=\"*\"/>"
"  <MAPPING commandId=\"1c\" description=\"Select loop 9.\" key=\"(\"/>"
"  <MAPPING commandId=\"1d\" description=\"Select loop 10.\" key=\")\"/>"
"</KEYMAPPINGS>";
