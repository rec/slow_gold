...
void protobuf_AssignDesc_Slow_2eproto() {
  protobuf_AddDesc_Slow_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_Slow_2eproto);
}
...
void protobuf_ShutdownFile_Slow_2eproto() {
  delete Preferences::default_instance_;
  delete Preferences_reflection_;
}

void protobuf_AddDesc_Slow_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\nSlow.proto\022\010rec.slow\032#rec/audio/stretc"
    "h/description.proto\032\032rec/components/Colo"
    "r.proto\032)rec/components/ThumbnailDescrip"
    "tion.proto\"u\n\013Preferences\0224\n\ttimescale\030\001"
    " \002(\0132!.rec.audio.timescaler.Description\022"
    "0\n\tthumbnail\030\002 \002(\0132\035.rec.gui.ThumbnailDe"
    "scription", 249);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "Slow.proto", &protobuf_RegisterTypes);
  Preferences::default_instance_ = new Preferences();
  Preferences::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_Slow_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_Slow_2eproto {
  StaticDescriptorInitializer_Slow_2eproto() {
    protobuf_AddDesc_Slow_2eproto();
  }
} static_descriptor_initializer_Slow_2eproto_;
...
const Preferences& Preferences::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_Slow_2eproto();  return *default_instance_;
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // required .rec.audio.timescaler.Description timescale = 1;
      case 1: {
      ...
      // required .rec.gui.ThumbnailDescription thumbnail = 2;
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_thumbnail:
