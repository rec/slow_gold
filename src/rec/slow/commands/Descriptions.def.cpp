...
"command {\n"
  ...
  "  desc {\n"
  "    menu: \"Clear All Settings\"\n"
  "    full: \"Clear all SlowGold settings for all tracks that have ever been visited.\"\n"
  "  }\n"
  "}\n"
  "command {\n"
  "  type: CLEAR_SETTINGS_FOR_THIS_TRACK\n"
  "  desc {\n"
  "    menu: \"Clear Settings For This Track\"\n"
  "    full: \"Clear all SlowGold settings for this track only.\"\n"
  "  }\n"
  "}\n"
  "command {\n"
