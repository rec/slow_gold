...
"command { type: ABOUT_THIS_PROGRAM category: \"(None)\"}\n"
  ...
  "command { type: SAVE_AS_AIFF category: \"Audio\"}\n"
  "command { type: SAVE_AS_FLAC category: \"Audio\"}\n"
  "command { type: SAVE_AS_MP3 category: \"Audio\"}\n"
  "command { type: SAVE_AS_OGG category: \"Audio\"}\n"
  "command { type: SAVE_AS_WAV category: \"Audio\"}\n"
  "command { type: SAVE_SELECTION_AS_AIFF category: \"Audio\"}\n"
  "command { type: SAVE_SELECTION_AS_FLAC category: \"Audio\"}\n"
  "command { type: SAVE_SELECTION_AS_MP3 category: \"Audio\"}\n"
  "command { type: SAVE_SELECTION_AS_OGG category: \"Audio\"}\n"
  "command { type: SAVE_SELECTION_AS_WAV category: \"Audio\"}\n"
