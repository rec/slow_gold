...
// new src/rec/gui/icon/SetTimeModeDisabled.svg

Drawable* SetTimeModeDisabled::create() {
  ...
  " "
;
  return createBinary<Drawable>(data, arraysize(data), "SetTimeModeDisabled.svg");
};
