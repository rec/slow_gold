...
_TABLECOLUMN_PROPERTIES = descriptor.EnumDescriptor(
  name='Properties',
...
_TABLECOLUMN_TYPE = descriptor.EnumDescriptor(
  name='Type',
...
_TABLECOLUMN = descriptor.Descriptor(
  name='TableColumn',
...
_TABLECOLUMNLIST = descriptor.Descriptor(
