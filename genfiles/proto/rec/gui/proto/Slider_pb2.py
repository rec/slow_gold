...
_SLIDERPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='suffix_spacing', full_name='rec.gui.SliderProto.suffix_spacing', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='minimum', full_name='rec.gui.SliderProto.minimum', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='maximum', full_name='rec.gui.SliderProto.maximum', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='interval', full_name='rec.gui.SliderProto.interval', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='style', full_name='rec.gui.SliderProto.style', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text_entry_box_position', full_name='rec.gui.SliderProto.text_entry_box_position', index=12,
