...
_SLIDERPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='address', full_name='rec.gui.SliderProto.address', index=5,
...
_SLIDERPROTO.fields_by_name['address'].message_type = rec.data.proto.Address_pb2._ADDRESSPROTO
