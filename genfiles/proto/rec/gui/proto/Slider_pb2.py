...
_SLIDERPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tooltip', full_name='rec.gui.SliderProto.tooltip', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text_entry_box_width', full_name='rec.gui.SliderProto.text_entry_box_width', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text_entry_box_height', full_name='rec.gui.SliderProto.text_entry_box_height', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data_address', full_name='rec.gui.SliderProto.data_address', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='detent', full_name='rec.gui.SliderProto.detent', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='detent_radius', full_name='rec.gui.SliderProto.detent_radius', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text_suffix', full_name='rec.gui.SliderProto.text_suffix', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='minimum', full_name='rec.gui.SliderProto.minimum', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='maximum', full_name='rec.gui.SliderProto.maximum', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='interval', full_name='rec.gui.SliderProto.interval', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='style', full_name='rec.gui.SliderProto.style', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text_entry_box_position', full_name='rec.gui.SliderProto.text_entry_box_position', index=13,
...
_SLIDERPROTO.fields_by_name['data_address'].message_type = rec.data.proto.Address_pb2._DATAADDRESS
