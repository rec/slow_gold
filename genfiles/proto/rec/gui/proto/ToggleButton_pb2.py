...
_TOGGLEBUTTONPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data_address', full_name='rec.gui.ToggleButtonProto.data_address', index=2,
...
_TOGGLEBUTTONPROTO.fields_by_name['data_address'].message_type = rec.data.proto.Address_pb2._DATAADDRESS
