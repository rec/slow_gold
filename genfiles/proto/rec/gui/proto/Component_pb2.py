...
import rec.gui.proto.Switcher_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='rec.gui',
  serialized_pb='\n\x1drec/gui/proto/Component.proto\x12\x07rec.gui\x1a\x13rec/gui/Color.proto\x1a\x1arec/gui/proto/Button.proto\x1a\x1crec/gui/proto/ComboBox.proto\x1a\x1arec/gui/proto/Custom.proto\x1a\x18rec/gui/proto/Font.proto\x1a\x18rec/gui/proto/Help.proto\x1a\x19rec/gui/proto/Label.proto\x1a\x1erec/gui/proto/LevelMeter.proto\x1a\x1brec/gui/proto/Resizer.proto\x1a\x18rec/gui/proto/Size.proto\x1a\x1arec/gui/proto/Slider.proto\x1a\x1crec/gui/proto/Switcher.proto\x1a\x18rec/gui/proto/Text.proto\x1a rec/gui/proto/ToggleButton.proto\x1a\x1crec/widget/status/Time.proto\"\x86\x06\n\x0e\x43omponentProto\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x0f\n\x07tooltip\x18\x02 \x01(\t\x12\x1b\n\x04size\x18\x03 \x01(\x0b\x32\r.rec.gui.Size\x12\x0f\n\x07\x61\x64\x64ress\x18\x04 \x01(\t\x12\x1d\n\x05\x63olor\x18\x05 \x03(\x0b\x32\x0e.rec.gui.Color\x12 \n\x04\x66ont\x18\x06 \x01(\x0b\x32\x12.rec.gui.FontProto\x12\x0e\n\x06layout\x18\x07 \x01(\t\x12\x0f\n\x07resizer\x18\x08 \x01(\t\x12\x18\n\x0bmin_resizer\x18\t \x01(\t:\x03\x30.0\x12\x10\n\x08\x64isabled\x18\n \x03(\t\x12$\n\x06\x62utton\x18\x0b \x01(\x0b\x32\x14.rec.gui.ButtonProto\x12)\n\tcombo_box\x18\x0c \x01(\x0b\x32\x16.rec.gui.ComboBoxProto\x12$\n\x06\x63ustom\x18\r \x01(\x0b\x32\x14.rec.gui.CustomProto\x12 \n\x04help\x18\x0e \x01(\x0b\x32\x12.rec.gui.HelpProto\x12\"\n\x05label\x18\x0f \x01(\x0b\x32\x13.rec.gui.LabelProto\x12-\n\x0blevel_meter\x18\x10 \x01(\x0b\x32\x18.rec.gui.LevelMeterProto\x12+\n\x0c\x66ull_resizer\x18\x11 \x01(\x0b\x32\x15.rec.gui.ResizerProto\x12$\n\x06slider\x18\x12 \x01(\x0b\x32\x14.rec.gui.SliderProto\x12(\n\x08switcher\x18\x13 \x01(\x0b\x32\x16.rec.gui.SwitcherProto\x12 \n\x04text\x18\x14 \x01(\x0b\x32\x12.rec.gui.TextProto\x12/\n\ttime_dial\x18\x15 \x01(\x0b\x32\x1c.rec.widget.status.time.Dial\x12*\n\x04time\x18\x16 \x01(\x0b\x32\x1c.rec.widget.status.time.Text\x12\x31\n\rtoggle_button\x18\x17 \x01(\x0b\x32\x1a.rec.gui.ToggleButtonProto')
...
_COMPONENTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disabled', full_name='rec.gui.ComponentProto.disabled', index=9,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='switcher', full_name='rec.gui.ComponentProto.switcher', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text', full_name='rec.gui.ComponentProto.text', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='time_dial', full_name='rec.gui.ComponentProto.time_dial', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='time', full_name='rec.gui.ComponentProto.time', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='toggle_button', full_name='rec.gui.ComponentProto.toggle_button', index=22,
...
_COMPONENTPROTO.fields_by_name['switcher'].message_type = rec.gui.proto.Switcher_pb2._SWITCHERPROTO
