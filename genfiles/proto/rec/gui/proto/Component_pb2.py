...
_COMPONENTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='toggle_button', full_name='rec.gui.ComponentProto.toggle_button', index=17,
