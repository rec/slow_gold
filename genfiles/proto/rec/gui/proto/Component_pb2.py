...
_COMPONENTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='custom', full_name='rec.gui.ComponentProto.custom', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='help', full_name='rec.gui.ComponentProto.help', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label', full_name='rec.gui.ComponentProto.label', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='full_resizer', full_name='rec.gui.ComponentProto.full_resizer', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='slider', full_name='rec.gui.ComponentProto.slider', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text', full_name='rec.gui.ComponentProto.text', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='toggle_button', full_name='rec.gui.ComponentProto.toggle_button', index=15,
