...
_COMPONENTPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text', full_name='rec.gui.ComponentProto.text', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='toggle_button', full_name='rec.gui.ComponentProto.toggle_button', index=13,
