...
inline const ::rec::data::DataAddress& ComboBoxProto::data_address() const {
  return data_address_ != NULL ? *data_address_ : *default_instance_->data_address_;
}
inline ::rec::data::DataAddress* ComboBoxProto::mutable_data_address() {
  set_has_data_address();
  if (data_address_ == NULL) data_address_ = new ::rec::data::DataAddress;
  return data_address_;
}
inline ::rec::data::DataAddress* ComboBoxProto::release_data_address() {
  clear_has_data_address();
  ::rec::data::DataAddress* temp = data_address_;
  data_address_ = NULL;
  return temp;
}
inline void ComboBoxProto::set_allocated_data_address(::rec::data::DataAddress* data_address) {
