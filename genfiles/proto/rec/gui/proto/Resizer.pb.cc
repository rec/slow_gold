...
void protobuf_AssignDesc_rec_2fgui_2fproto_2fResizer_2eproto() {
  ...
  static const int ResizerProto_offsets_[1] = {
...
void protobuf_AddDesc_rec_2fgui_2fproto_2fResizer_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\033rec/gui/proto/Resizer.proto\022\007rec.gui\"!"
    "\n\014ResizerProto\022\021\n\tmin_value\030\001 \001(\t", 73);
