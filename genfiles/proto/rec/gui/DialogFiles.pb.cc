...
const ::std::string DialogFile::_default_dialog_name_;
const ::std::string DialogFile::_default_file_name_;
#ifndef _MSC_VER
...
void DialogFile::SharedCtor() {
  _cached_size_ = 0;
  dialog_name_ = const_cast< ::std::string*>(&_default_dialog_name_);
...
const DialogFile& DialogFile::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_rec_2fgui_2fDialogFiles_2eproto();  return *default_instance_;
}
