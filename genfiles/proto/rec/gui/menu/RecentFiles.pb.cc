...
void protobuf_AssignDesc_rec_2fgui_2fmenu_2fRecentFiles_2eproto() {
  protobuf_AddDesc_rec_2fgui_2fmenu_2fRecentFiles_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "rec/gui/menu/RecentFiles.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_rec_2fgui_2fmenu_2fRecentFiles_2eproto);
}
...
void protobuf_AddDesc_rec_2fgui_2fmenu_2fRecentFiles_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\036rec/gui/menu/RecentFiles.proto\022\007rec.gu"
    "i\032\030rec/music/Metadata.proto\032\037rec/util/fi"
    "le/VirtualFile.proto\"\211\001\n\nRecentFile\022\021\n\tt"
    "imestamp\030\001 \001(\003\022(\n\004file\030\002 \001(\0132\032.rec.util."
    "file.VirtualFile\022%\n\010metadata\030\003 \001(\0132\023.rec"
    ".music.Metadata\022\027\n\017metadata_string\030\004 \001(\t"
    "\"i\n\013RecentFiles\022!\n\004file\030\003 \003(\0132\023.rec.gui."
    "RecentFile\022\025\n\tmax_files\030\004 \001(\005:\00216\022 \n\022rel"
    "oad_most_recent\030\005 \001(\010:\004true", 347);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "rec/gui/menu/RecentFiles.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_rec_2fgui_2fmenu_2fRecentFiles_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_rec_2fgui_2fmenu_2fRecentFiles_2eproto {
  StaticDescriptorInitializer_rec_2fgui_2fmenu_2fRecentFiles_2eproto() {
    protobuf_AddDesc_rec_2fgui_2fmenu_2fRecentFiles_2eproto();
  }
} static_descriptor_initializer_rec_2fgui_2fmenu_2fRecentFiles_2eproto_;
...
void RecentFile::InitAsDefaultInstance() {
  ...
  metadata_ = const_cast< ::rec::music::Metadata*>(&::rec::music::Metadata::default_instance());
}
...
const RecentFile& RecentFile::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_rec_2fgui_2fmenu_2fRecentFiles_2eproto();
...
void RecentFiles::MergeFrom(const RecentFiles& from) {
  ...
  if (from._has_bits_[1 / 32] & (0xffu << (1 % 32))) {
    ...
    if (from.has_reload_most_recent()) {
