...
// source: rec/gui/LoopPoint.proto

#ifndef PROTOBUF_rec_2fgui_2fLoopPoint_2eproto__INCLUDED
#define PROTOBUF_rec_2fgui_2fLoopPoint_2eproto__INCLUDED
...
class LoopPoint : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rec.gui.LoopPoint)
 private:
...
class LoopPointList : public ::google::protobuf::Message {
 public:
  ...
  inline const ::rec::gui::LoopPoint& loop_point(int index) const;
  inline ::rec::gui::LoopPoint* mutable_loop_point(int index);
  inline ::rec::gui::LoopPoint* add_loop_point();
  inline const ::google::protobuf::RepeatedPtrField< ::rec::gui::LoopPoint >&
      loop_point() const;
...
inline const ::rec::gui::LoopPoint& LoopPointList::loop_point(int index) const {
  return loop_point_.Get(index);
}
inline ::rec::gui::LoopPoint* LoopPointList::mutable_loop_point(int index) {
  return loop_point_.Mutable(index);
}
inline ::rec::gui::LoopPoint* LoopPointList::add_loop_point() {
...
#endif  // PROTOBUF_rec_2fgui_2fLoopPoint_2eproto__INCLUDED
