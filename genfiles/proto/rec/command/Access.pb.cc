...
void protobuf_ShutdownFile_rec_2fcommand_2fAccess_2eproto() {
  ...
  delete Global::_default_language_;
...
::std::string* Global::_default_language_ = NULL;
#ifndef _MSC_VER
...
const Global& Global::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_rec_2fcommand_2fAccess_2eproto();
