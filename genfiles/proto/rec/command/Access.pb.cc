...
void protobuf_AssignDesc_rec_2fcommand_2fAccess_2eproto() {
  protobuf_AddDesc_rec_2fcommand_2fAccess_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "rec/command/Access.proto");
  GOOGLE_CHECK(file != NULL);
  Global_descriptor_ = file->message_type(0);
  static const int Global_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Global, language_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Global, locale_),
  };
  Global_reflection_ =
  ...
  static const int Access_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Access, global_),
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_rec_2fcommand_2fAccess_2eproto);
}
...
void protobuf_AddDesc_rec_2fcommand_2fAccess_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\030rec/command/Access.proto\022\013rec.command\""
    ".\n\006Global\022\024\n\010language\030\001 \001(\t:\002en\022\016\n\006local"
    "e\030\002 \001(\t\"\025\n\005Input\022\014\n\004name\030\001 \001(\t\"\026\n\006Output"
    "\022\014\n\004name\030\001 \001(\t\"u\n\006Access\022#\n\006global\030\001 \001(\013"
    "2\023.rec.command.Global\022!\n\005input\030\002 \003(\0132\022.r"
    "ec.command.Input\022#\n\006output\030\003 \003(\0132\023.rec.c"
    "ommand.Output", 253);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "rec/command/Access.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_rec_2fcommand_2fAccess_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_rec_2fcommand_2fAccess_2eproto {
  StaticDescriptorInitializer_rec_2fcommand_2fAccess_2eproto() {
    protobuf_AddDesc_rec_2fcommand_2fAccess_2eproto();
  }
} static_descriptor_initializer_rec_2fcommand_2fAccess_2eproto_;


// ===================================================================

const ::std::string Global::_default_language_("en");
const ::std::string Global::_default_locale_;
#ifndef _MSC_VER
const int Global::kLanguageFieldNumber;
const int Global::kLocaleFieldNumber;
#endif  // !_MSC_VER
...
const Global& Global::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_rec_2fcommand_2fAccess_2eproto();  return *default_instance_;
}
...
#ifndef _MSC_VER
const int Access::kGlobalFieldNumber;
...
void Access::InitAsDefaultInstance() {
  global_ = const_cast< ::rec::command::Global*>(&::rec::command::Global::default_instance());
}
...
void Access::MergeFrom(const Access& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from._has_bit(0)) {
      mutable_global()->::rec::command::Global::MergeFrom(from.global());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
