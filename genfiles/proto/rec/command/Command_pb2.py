...
_COMMAND = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='is_setter', full_name='rec.command.Command.is_setter', index=6,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='is_global_setter', full_name='rec.command.Command.is_global_setter', index=7,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='address', full_name='rec.command.Command.address', index=8,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='setter_type_name', full_name='rec.command.Command.setter_type_name', index=9,
...
_COMMAND.fields_by_name['address'].message_type = rec.data.proto.Address_pb2._ADDRESSPROTO
