...
inline void ThreadDescription::set_has_priority() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ThreadDescription::clear_has_priority() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void ThreadDescription::set_has_period() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ThreadDescription::clear_has_period() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline void ThreadDescription::set_has_name() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ThreadDescription::clear_has_name() {
  _has_bits_[0] &= ~0x00000004u;
}
...
inline ::std::string* ThreadDescription::release_name() {
  clear_has_name();
  if (name_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void ThreadDescription::set_allocated_name(::std::string* name) {
  if (name_ != &::google::protobuf::internal::kEmptyString) {
    delete name_;
  }
  if (name) {
