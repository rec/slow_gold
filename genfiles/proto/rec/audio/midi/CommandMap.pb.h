...
// source: rec/audio/midi/CommandMap.proto

#ifndef PROTOBUF_rec_2faudio_2fmidi_2fCommandMap_2eproto__INCLUDED
#define PROTOBUF_rec_2faudio_2fmidi_2fCommandMap_2eproto__INCLUDED
...
void  protobuf_AddDesc_rec_2faudio_2fmidi_2fCommandMap_2eproto();
void protobuf_AssignDesc_rec_2faudio_2fmidi_2fCommandMap_2eproto();
void protobuf_ShutdownFile_rec_2faudio_2fmidi_2fCommandMap_2eproto();
...
class CommandMapEntry : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rec.audio.midi.CommandMapEntry)
 private:
  ...
  int command_;
  friend void  protobuf_AddDesc_rec_2faudio_2fmidi_2fCommandMap_2eproto();
  friend void protobuf_AssignDesc_rec_2faudio_2fmidi_2fCommandMap_2eproto();
  friend void protobuf_ShutdownFile_rec_2faudio_2fmidi_2fCommandMap_2eproto();
...
class CommandMapProto : public ::google::protobuf::Message {
 public:
  ...
  // repeated .rec.audio.midi.CommandMapEntry entry = 1;
  inline int entry_size() const;
  inline void clear_entry();
  static const int kEntryFieldNumber = 1;
  inline const ::rec::audio::midi::CommandMapEntry& entry(int index) const;
  inline ::rec::audio::midi::CommandMapEntry* mutable_entry(int index);
  inline ::rec::audio::midi::CommandMapEntry* add_entry();
  inline const ::google::protobuf::RepeatedPtrField< ::rec::audio::midi::CommandMapEntry >&
      entry() const;
  inline ::google::protobuf::RepeatedPtrField< ::rec::audio::midi::CommandMapEntry >*
      mutable_entry();
  
  // @@protoc_insertion_point(class_scope:rec.audio.midi.CommandMapProto)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
  
  ::google::protobuf::RepeatedPtrField< ::rec::audio::midi::CommandMapEntry > entry_;
  friend void  protobuf_AddDesc_rec_2faudio_2fmidi_2fCommandMap_2eproto();
  friend void protobuf_AssignDesc_rec_2faudio_2fmidi_2fCommandMap_2eproto();
  friend void protobuf_ShutdownFile_rec_2faudio_2fmidi_2fCommandMap_2eproto();
...
inline const ::rec::audio::midi::CommandMapEntry& CommandMapProto::entry(int index) const {
  return entry_.Get(index);
}
inline ::rec::audio::midi::CommandMapEntry* CommandMapProto::mutable_entry(int index) {
  return entry_.Mutable(index);
}
inline ::rec::audio::midi::CommandMapEntry* CommandMapProto::add_entry() {
  return entry_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::rec::audio::midi::CommandMapEntry >&
...
#endif  // PROTOBUF_rec_2faudio_2fmidi_2fCommandMap_2eproto__INCLUDED
