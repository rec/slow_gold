...
_STRETCH_STRATEGY = descriptor.EnumDescriptor(
  name='Strategy',
...
_STRETCH = descriptor.Descriptor(
  name='Stretch',
...
_STRETCHPARAMETERS = descriptor.Descriptor(
