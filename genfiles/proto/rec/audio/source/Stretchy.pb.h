...
class StretchyDesc : public ::google::protobuf::Message {
 public:
  StretchyDesc();
  virtual ~StretchyDesc();
  
  StretchyDesc(const StretchyDesc& from);
  
  inline StretchyDesc& operator=(const StretchyDesc& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const StretchyDesc& default_instance();
  
  void Swap(StretchyDesc* other);
  
  // implements Message ----------------------------------------------
  
  StretchyDesc* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const StretchyDesc& from);
  void MergeFrom(const StretchyDesc& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:rec.audio.source.StretchyDesc)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
  ...
  void InitAsDefaultInstance();
  static StretchyDesc* default_instance_;
};
// -------------------------------------------------------------------

class StretchyRunnyDesc : public ::google::protobuf::Message {
 public:
  StretchyRunnyDesc();
  virtual ~StretchyRunnyDesc();
  
  StretchyRunnyDesc(const StretchyRunnyDesc& from);
  
  inline StretchyRunnyDesc& operator=(const StretchyRunnyDesc& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const StretchyRunnyDesc& default_instance();
  
  void Swap(StretchyRunnyDesc* other);
  
  // implements Message ----------------------------------------------
  
  StretchyRunnyDesc* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const StretchyRunnyDesc& from);
  void MergeFrom(const StretchyRunnyDesc& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline const ::rec::audio::source::StretchyDesc& stretchy() const;
  inline ::rec::audio::source::StretchyDesc* mutable_stretchy();
  
  // optional .rec.audio.source.RunnyDesc runny = 2;
  inline bool has_runny() const;
  inline void clear_runny();
  static const int kRunnyFieldNumber = 2;
  inline const ::rec::audio::source::RunnyDesc& runny() const;
  inline ::rec::audio::source::RunnyDesc* mutable_runny();
  
  // @@protoc_insertion_point(class_scope:rec.audio.source.StretchyRunnyDesc)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
  
  ::rec::audio::source::StretchyDesc* stretchy_;
  ...
  void InitAsDefaultInstance();
  static StretchyRunnyDesc* default_instance_;
};
// ===================================================================
...
// optional .rec.audio.source.TimeStretch stretch = 1;
inline bool StretchyDesc::has_stretch() const {
  return _has_bit(0);
}
inline void StretchyDesc::clear_stretch() {
  if (stretch_ != NULL) stretch_->::rec::audio::source::TimeStretch::Clear();
  _clear_bit(0);
}
inline const ::rec::audio::source::TimeStretch& StretchyDesc::stretch() const {
  return stretch_ != NULL ? *stretch_ : *default_instance_->stretch_;
}
inline ::rec::audio::source::TimeStretch* StretchyDesc::mutable_stretch() {
  _set_bit(0);
...
// optional .rec.widget.tree.VolumeFile file = 2;
inline bool StretchyDesc::has_file() const {
  return _has_bit(1);
}
inline void StretchyDesc::clear_file() {
  if (file_ != NULL) file_->::rec::widget::tree::VolumeFile::Clear();
  _clear_bit(1);
}
inline const ::rec::widget::tree::VolumeFile& StretchyDesc::file() const {
  return file_ != NULL ? *file_ : *default_instance_->file_;
}
inline ::rec::widget::tree::VolumeFile* StretchyDesc::mutable_file() {
  _set_bit(1);
...
// optional .rec.audio.source.StretchyDesc stretchy = 1;
inline bool StretchyRunnyDesc::has_stretchy() const {
  return _has_bit(0);
}
inline void StretchyRunnyDesc::clear_stretchy() {
  if (stretchy_ != NULL) stretchy_->::rec::audio::source::StretchyDesc::Clear();
  _clear_bit(0);
}
inline const ::rec::audio::source::StretchyDesc& StretchyRunnyDesc::stretchy() const {
  return stretchy_ != NULL ? *stretchy_ : *default_instance_->stretchy_;
}
inline ::rec::audio::source::StretchyDesc* StretchyRunnyDesc::mutable_stretchy() {
  _set_bit(0);
  if (stretchy_ == NULL) stretchy_ = new ::rec::audio::source::StretchyDesc;
  return stretchy_;
}

// optional .rec.audio.source.RunnyDesc runny = 2;
inline bool StretchyRunnyDesc::has_runny() const {
  return _has_bit(1);
}
inline void StretchyRunnyDesc::clear_runny() {
  if (runny_ != NULL) runny_->::rec::audio::source::RunnyDesc::Clear();
  _clear_bit(1);
}
inline const ::rec::audio::source::RunnyDesc& StretchyRunnyDesc::runny() const {
  return runny_ != NULL ? *runny_ : *default_instance_->runny_;
}
inline ::rec::audio::source::RunnyDesc* StretchyRunnyDesc::mutable_runny() {
  _set_bit(1);
