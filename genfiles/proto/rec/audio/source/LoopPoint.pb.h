...
// source: rec/audio/source/LoopPoint.proto

#ifndef PROTOBUF_rec_2faudio_2fsource_2fLoopPoint_2eproto__INCLUDED
#define PROTOBUF_rec_2faudio_2fsource_2fLoopPoint_2eproto__INCLUDED
...
void  protobuf_AddDesc_rec_2faudio_2fsource_2fLoopPoint_2eproto();
void protobuf_AssignDesc_rec_2faudio_2fsource_2fLoopPoint_2eproto();
void protobuf_ShutdownFile_rec_2faudio_2fsource_2fLoopPoint_2eproto();
...
class LoopPoint : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rec.audio.source.LoopPoint)
 private:
  ...
  friend void  protobuf_AddDesc_rec_2faudio_2fsource_2fLoopPoint_2eproto();
  friend void protobuf_AssignDesc_rec_2faudio_2fsource_2fLoopPoint_2eproto();
  friend void protobuf_ShutdownFile_rec_2faudio_2fsource_2fLoopPoint_2eproto();
...
class LoopPointList : public ::google::protobuf::Message {
 public:
  ...
  // repeated .rec.audio.source.LoopPoint loop_point = 1;
  inline int loop_point_size() const;
  inline void clear_loop_point();
  static const int kLoopPointFieldNumber = 1;
  inline const ::rec::audio::source::LoopPoint& loop_point(int index) const;
  inline ::rec::audio::source::LoopPoint* mutable_loop_point(int index);
  inline ::rec::audio::source::LoopPoint* add_loop_point();
  inline const ::google::protobuf::RepeatedPtrField< ::rec::audio::source::LoopPoint >&
      loop_point() const;
  inline ::google::protobuf::RepeatedPtrField< ::rec::audio::source::LoopPoint >*
      mutable_loop_point();
  ...
  // @@protoc_insertion_point(class_scope:rec.audio.source.LoopPointList)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
  
  ::google::protobuf::RepeatedPtrField< ::rec::audio::source::LoopPoint > loop_point_;
...
inline const ::rec::audio::source::LoopPoint& LoopPointList::loop_point(int index) const {
  return loop_point_.Get(index);
}
inline ::rec::audio::source::LoopPoint* LoopPointList::mutable_loop_point(int index) {
  return loop_point_.Mutable(index);
}
inline ::rec::audio::source::LoopPoint* LoopPointList::add_loop_point() {
...
#endif  // PROTOBUF_rec_2faudio_2fsource_2fLoopPoint_2eproto__INCLUDED
