...
_SLOWCOMMAND_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FIRST_FREE_TYPE', index=95, number=97,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JUCE_START', index=103, number=4096,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JUCE_END', index=104, number=4104,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_SLOWCOMMAND = _descriptor.Descriptor(
  name='SlowCommand',
  full_name='SlowCommand',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='SlowCommand.type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='command', full_name='SlowCommand.command', index=1,
...
_SLOWCOMMANDS = _descriptor.Descriptor(
  name='SlowCommands',
  full_name='SlowCommands',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='slow_command', full_name='SlowCommands.slow_command', index=0,
