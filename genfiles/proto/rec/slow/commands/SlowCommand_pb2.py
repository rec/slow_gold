...
_SLOWCOMMAND_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_SAVE_TYPE', index=62, number=1010000,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JUCE_START', index=108, number=4096,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JUCE_END', index=109, number=4104,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BANK_SIZE', index=110, number=10000,
      options=None,
      type=None),
  ],
