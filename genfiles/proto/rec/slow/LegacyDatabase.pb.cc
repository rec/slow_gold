...
const ::std::string LegacyLoopPoint::_default_comment_;
const ::std::string LegacyLoopPoint::_default_chords_;
const ::std::string LegacyLoopPoint::_default_lyrics_;
const ::std::string LegacyLoopPoint::_default_notation_;
#ifndef _MSC_VER
...
void LegacyLoopPoint::SharedCtor() {
  ...
  chords_ = const_cast< ::std::string*>(&_default_chords_);
  lyrics_ = const_cast< ::std::string*>(&_default_lyrics_);
  notation_ = const_cast< ::std::string*>(&_default_notation_);
...
const LegacyLoopPoint& LegacyLoopPoint::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_rec_2fslow_2fLegacyDatabase_2eproto();  return *default_instance_;
}
...
const ::std::string Track::_default_comments_;
const ::std::string Track::_default_notation_;
#ifndef _MSC_VER
...
void Track::SharedCtor() {
  ...
  comments_ = const_cast< ::std::string*>(&_default_comments_);
  notation_ = const_cast< ::std::string*>(&_default_notation_);
...
const ::std::string CD::_default_title_;
const ::std::string CD::_default_artist_;
#ifndef _MSC_VER
