...
// source: rec/widget/time/Time.proto

#ifndef PROTOBUF_rec_2fwidget_2ftime_2fTime_2eproto__INCLUDED
#define PROTOBUF_rec_2fwidget_2ftime_2fTime_2eproto__INCLUDED
...
void  protobuf_AddDesc_rec_2fwidget_2ftime_2fTime_2eproto();
void protobuf_AssignDesc_rec_2fwidget_2ftime_2fTime_2eproto();
void protobuf_ShutdownFile_rec_2fwidget_2ftime_2fTime_2eproto();
...
class Text_Separator : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rec.widget.time.Text.Separator)
 private:
  ...
  bool flash_;
  friend void  protobuf_AddDesc_rec_2fwidget_2ftime_2fTime_2eproto();
  friend void protobuf_AssignDesc_rec_2fwidget_2ftime_2fTime_2eproto();
  friend void protobuf_ShutdownFile_rec_2fwidget_2ftime_2fTime_2eproto();
...
class Text_Fields : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rec.widget.time.Text.Fields)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
...
class Text : public ::google::protobuf::Message {
 public:
  ...
  // optional .rec.widget.time.Text.Separator separator = 2;
  inline bool has_separator() const;
  inline void clear_separator();
  static const int kSeparatorFieldNumber = 2;
  inline const ::rec::widget::time::Text_Separator& separator() const;
  inline ::rec::widget::time::Text_Separator* mutable_separator();
  
  // optional .rec.widget.time.Text.Fields fields = 3;
  inline bool has_fields() const;
  inline void clear_fields();
  static const int kFieldsFieldNumber = 3;
  inline const ::rec::widget::time::Text_Fields& fields() const;
  inline ::rec::widget::time::Text_Fields* mutable_fields();
  
  // @@protoc_insertion_point(class_scope:rec.widget.time.Text)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
  
  ::rec::widget::Widget* widget_;
  ::rec::widget::time::Text_Separator* separator_;
  ::rec::widget::time::Text_Fields* fields_;
  friend void  protobuf_AddDesc_rec_2fwidget_2ftime_2fTime_2eproto();
  friend void protobuf_AssignDesc_rec_2fwidget_2ftime_2fTime_2eproto();
  friend void protobuf_ShutdownFile_rec_2fwidget_2ftime_2fTime_2eproto();
...
class Bar : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rec.widget.time.Bar)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
...
class Dial : public ::google::protobuf::Message {
 public:
  ...
  // optional .rec.widget.time.Dial.Direction direction = 3 [default = CLOCKWISE];
  inline bool has_direction() const;
  inline void clear_direction();
  static const int kDirectionFieldNumber = 3;
  inline ::rec::widget::time::Dial_Direction direction() const;
  inline void set_direction(::rec::widget::time::Dial_Direction value);
  ...
  // @@protoc_insertion_point(class_scope:rec.widget.time.Dial)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
...
class Time : public ::google::protobuf::Message {
 public:
  ...
  // optional .rec.widget.time.Text text = 1;
  inline bool has_text() const;
  inline void clear_text();
  static const int kTextFieldNumber = 1;
  inline const ::rec::widget::time::Text& text() const;
  inline ::rec::widget::time::Text* mutable_text();
  
  // optional .rec.widget.time.Dial dial = 2;
  inline bool has_dial() const;
  inline void clear_dial();
  static const int kDialFieldNumber = 2;
  inline const ::rec::widget::time::Dial& dial() const;
  inline ::rec::widget::time::Dial* mutable_dial();
  
  // optional .rec.widget.time.Bar bar = 3;
  inline bool has_bar() const;
  inline void clear_bar();
  static const int kBarFieldNumber = 3;
  inline const ::rec::widget::time::Bar& bar() const;
  inline ::rec::widget::time::Bar* mutable_bar();
  
  // @@protoc_insertion_point(class_scope:rec.widget.time.Time)
 private:
  ::google::protobuf::UnknownFieldSet _unknown_fields_;
  mutable int _cached_size_;
  
  ::rec::widget::time::Text* text_;
  ::rec::widget::time::Dial* dial_;
  ::rec::widget::time::Bar* bar_;
  friend void  protobuf_AddDesc_rec_2fwidget_2ftime_2fTime_2eproto();
  friend void protobuf_AssignDesc_rec_2fwidget_2ftime_2fTime_2eproto();
  friend void protobuf_ShutdownFile_rec_2fwidget_2ftime_2fTime_2eproto();
...
inline void Text::clear_separator() {
  if (separator_ != NULL) separator_->::rec::widget::time::Text_Separator::Clear();
  _clear_bit(1);
}
inline const ::rec::widget::time::Text_Separator& Text::separator() const {
  return separator_ != NULL ? *separator_ : *default_instance_->separator_;
}
inline ::rec::widget::time::Text_Separator* Text::mutable_separator() {
  _set_bit(1);
  if (separator_ == NULL) separator_ = new ::rec::widget::time::Text_Separator;
  return separator_;
}
...
inline void Text::clear_fields() {
  if (fields_ != NULL) fields_->::rec::widget::time::Text_Fields::Clear();
  _clear_bit(2);
}
inline const ::rec::widget::time::Text_Fields& Text::fields() const {
  return fields_ != NULL ? *fields_ : *default_instance_->fields_;
}
inline ::rec::widget::time::Text_Fields* Text::mutable_fields() {
  _set_bit(2);
  if (fields_ == NULL) fields_ = new ::rec::widget::time::Text_Fields;
  return fields_;
}
...
inline ::rec::widget::time::Dial_Direction Dial::direction() const {
  return static_cast< ::rec::widget::time::Dial_Direction >(direction_);
}
inline void Dial::set_direction(::rec::widget::time::Dial_Direction value) {
  GOOGLE_DCHECK(::rec::widget::time::Dial_Direction_IsValid(value));
  _set_bit(2);
  direction_ = value;
}
...
inline void Time::clear_text() {
  if (text_ != NULL) text_->::rec::widget::time::Text::Clear();
  _clear_bit(0);
}
inline const ::rec::widget::time::Text& Time::text() const {
  return text_ != NULL ? *text_ : *default_instance_->text_;
}
inline ::rec::widget::time::Text* Time::mutable_text() {
  _set_bit(0);
  if (text_ == NULL) text_ = new ::rec::widget::time::Text;
  return text_;
}
...
inline void Time::clear_dial() {
  if (dial_ != NULL) dial_->::rec::widget::time::Dial::Clear();
  _clear_bit(1);
}
inline const ::rec::widget::time::Dial& Time::dial() const {
  return dial_ != NULL ? *dial_ : *default_instance_->dial_;
}
inline ::rec::widget::time::Dial* Time::mutable_dial() {
  _set_bit(1);
  if (dial_ == NULL) dial_ = new ::rec::widget::time::Dial;
  return dial_;
}
...
inline void Time::clear_bar() {
  if (bar_ != NULL) bar_->::rec::widget::time::Bar::Clear();
  _clear_bit(2);
}
inline const ::rec::widget::time::Bar& Time::bar() const {
  return bar_ != NULL ? *bar_ : *default_instance_->bar_;
}
inline ::rec::widget::time::Bar* Time::mutable_bar() {
  _set_bit(2);
  if (bar_ == NULL) bar_ = new ::rec::widget::time::Bar;
  return bar_;
}
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::rec::widget::time::Dial_Direction>() {
  return ::rec::widget::time::Dial_Direction_descriptor();
}
...
#endif  // PROTOBUF_rec_2fwidget_2ftime_2fTime_2eproto__INCLUDED
