...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/AddLoopPointButtonDisabled.svg
...
Drawable* AddLoopPointButtonDisabled::create() {
  ...
  "     \n"
  "			\n"
  "    <circle cx=\"13\" cy=\"12.972\" fill=\"#CCCCCC\" i:knockout=\"Off\" r=\"8.025\"/>\n"
  "     \n"
  "			\n"
  "    <polygon fill=\"#FFFFFF\" i:knockout=\"Off\" points=\"14.095,12.203 10.797,12.203 10.797,8.796 9.219,8.796 9.219,"
  "12.203      5.923,12.203 5.923,13.835 9.219,13.835 9.219,17.239 10.797,17.239 10.797,13.835 14.095,13.835 \"/>\n"
  "    \n"
  "			\n"
  "    <polygon fill=\"#FFFFFF\" i:knockout=\"Off\" points=\"18.688,10.335 18.688,8.736 17.527,8.736 17.527,8.731 "
  "16.771,9.91      15.98,8.731 15.98,8.736 14.82,8.736 14.82,10.335 15.98,10.335 15.98,15.613 14.82,15.613 14.82,17.213 "
  "16.067,17.213      16.771,15.889 17.482,17.213 18.688,17.213 18.688,15.613 17.527,15.613 17.527,10.335 \"/>\n"
  "    \n"
  "		\n"
  "  </g>\n"
  "  \n"
