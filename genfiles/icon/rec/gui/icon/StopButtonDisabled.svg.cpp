...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/StopButtonDisabled.svg
...
Drawable* StopButtonDisabled::create() {
  ...
  "     \n"
  "			\n"
  "    <rect fill=\"#CCCCCC\" height=\"13.747\" i:knockout=\"Off\" width=\"14.342\" x=\"5.865\" y=\"6.228\"/>\n"
  "     \n"
  "		\n"
  "  </g>\n"
  "  \n"
