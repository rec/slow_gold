...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/PlayButtonDisabled.svg
...
Drawable* PlayButtonDisabled::create() {
  ...
  "     \n"
  "			\n"
  "    <polygon fill=\"#CCCCCC\" i:knockout=\"Off\" points=\"6.5,21 6.5,5 23.099,12.96 \"/>\n"
  "    \n"
  "		\n"
  "  </g>\n"
  "  \n"
