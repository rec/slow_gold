...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/JumpBackButtonPressed.svg
...
Drawable* JumpBackButtonPressed::create() {
  ...
  "     \n"
  "			\n"
  "    <polygon fill=\"#666666\" i:knockout=\"Off\" points=\"20.032,5.695 9.368,12.669 9.368,5.594 6.519,5.594 6.519,"
