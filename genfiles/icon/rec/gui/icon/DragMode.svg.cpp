...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/DragMode.svg
...
Drawable* DragMode::create() {
  ...
  "      \n"
  "				\n"
  "      <path d=\"M12.44,3.757c-0.791,0.482-1.036,1.151-1.076,1.756c-0.005-0.009-0.079-0.155-0.079-0.155      "
  "c-0.796-1.47-2.171-1.188-2.634-0.955C8.141,4.655,7.79,5.047,7.642,5.538C7.583,5.732,7.56,5.928,7.56,6.116      c0,0.722,"
  "0.347,1.344,0.396,1.428c0,0,0.641,1.13,1.277,2.25c-0.71-0.623-1.481-1.299-1.481-1.299      C6.621,7.712,5.431,8.237,"
  "4.953,8.62C4.911,8.653,4.875,8.693,4.846,8.738c-0.309,0.476-0.425,0.929-0.425,1.338      c0,0.782,0.429,1.399,0.764,"
  "1.688c0,0,3.461,2.762,3.598,2.871c0.01,0.018,0.091,0.152,0.124,0.208      "
  "c-0.662-0.354-1.334-0.711-1.334-0.711c-0.722-0.281-1.316-0.288-1.82-0.046c-0.689,0.33-0.919,0.991-0.943,1.065      "
  "c-0.12,0.284-0.18,0.567-0.18,0.843c0,0.261,0.055,0.515,0.166,0.754c0.381,0.823,1.275,1.127,1.376,1.159      c0,0,6.469,"
  "3.296,6.71,3.419c0.115,0.187,0.565,0.914,0.565,0.914c0.145,0.235,0.453,0.308,0.688,0.163      c0.235-0.146,0.308-0.454,"
  "0.163-0.688l-0.639-1.033c-0.048-0.078-0.117-0.142-0.199-0.183l-6.91-3.514      "
  ...
  "3.72,12.44,3.757z\" i:knockout=\"Off\"/>\n"
  "      \n"
  "			\n"
  "    </g>\n"
  "    \n"
  ...
  "C13.234,3.676,12.571,3.972,12.543,3.984z\" i:knockout=\"Off\"/>\n"
  "      \n"
  "			\n"
  "    </g>\n"
  "    \n"
