...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/JumpToStartButton.svg
...
Drawable* JumpToStartButton::create() {
  ...
  "     \n"
  "			\n"
  "    <polygon i:knockout=\"Off\" points=\"21.365,5.614 14.713,10.915 14.713,5.614 7.906,11.038 7.906,5.594 5.057,"
  "5.594 5.057,20.637      7.906,20.637 7.906,15.132 14.713,20.609 14.713,15.256 21.365,20.609 \"/>\n"
  "    \n"
  "		\n"
  "  </g>\n"
  "  \n"
