...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/JumpBackButtonDisabled.svg
...
Drawable* JumpBackButtonDisabled::create() {
  ...
  "     \n"
  "			\n"
  "    <polygon fill=\"#CCCCCC\" i:knockout=\"Off\" points=\"20.032,5.695 9.368,12.669 9.368,5.594 6.519,5.594 6.519,"
  "20.637 9.368,20.637      9.368,13.357 20.032,20.527 \"/>\n"
  "    \n"
  "		\n"
  "  </g>\n"
  "  \n"
