...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/AddLoopPointModeDisabled.svg
...
Drawable* AddLoopPointModeDisabled::create() {
  ...
  "     \n"
  "			\n"
  "    <circle cx=\"13\" cy=\"12.96\" fill=\"#CCCCCC\" i:knockout=\"Off\" r=\"8.025\"/>\n"
  "     \n"
  "			\n"
