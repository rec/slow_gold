...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/JumpForwardButtonPressed.svg
...
Drawable* JumpForwardButtonPressed::create() {
  ...
  "     \n"
  "			\n"
  "    <polygon fill=\"#666666\" i:knockout=\"Off\" points=\"6.296,5.695 16.96,12.669 16.96,5.594 19.809,5.594 19.809,"
