...
// new --namespace=rec.gui.icon --output=genfiles/icon/rec/gui/icon art/icon/JumpForwardButton.svg
...
Drawable* JumpForwardButton::create() {
  ...
  "     \n"
  "			\n"
  "    <polygon i:knockout=\"Off\" points=\"6.296,5.695 16.96,12.669 16.96,5.594 19.809,5.594 19.809,20.637 16.96,"
  "20.637 16.96,13.357      6.296,20.527 \"/>\n"
  "    \n"
  "		\n"
  "  </g>\n"
  "  \n"
